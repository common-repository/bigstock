...
Mosaic.Grid = function (options) {
  this.setOptions(options || {});
};

Mosaic.Grid.prototype = {
  ...
  layout: function (images) {
    var instance = this;
    var rows = [new Mosaic.Row(instance)];
    images.forEach(
      function (image) {
        ...
        if (!fits) {
          rows.push(new Mosaic.Row(instance));
...
Mosaic.Row.prototype = {
  ...
  addImage: function (image) {
    ...
    this._cells.push(new Mosaic.Cell(this._grid, image));
...
Mosaic.Cell = function (grid, image) {
  this._grid = grid;
  this._image = image;
